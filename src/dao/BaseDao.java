...
/**
* @Description: 功能：通过使用泛型，将所有的dao操作定义;
...
public interface BaseDao<T> {
     ...
     * @return List
     */
    <K> List<K> findVO(String hql, Map<String, Object> params);
     ...
     * @return List
     */
    <K> List<K> findVO(String hql, int page, int rows);
     ...
     * @return List
     */
    <K> List<K> findVO(String hql, Map<String, Object> params, int page, int rows);
	/**
	 *
	...
	public <T> List<T> findByProperty(final String[] propertyNames, final Object[] values, final Integer startRow,
                                      final Integer pageSize, final String sortColumn, final boolean isDesc);
	 ...
	 *直接执行sql语句,返回主键
	 */
	int insertBySql(String sql, Object[] objects);
}
